# Repurpose SAM-IoT Wx Development Board to Connect to Azure through IoT Hub Device Provisioning Service (DPS)
...
4.  Modify `AzureIotPnpDps\Header Files\iot_config\cloud_config.h` with your DPS ID Scope:
